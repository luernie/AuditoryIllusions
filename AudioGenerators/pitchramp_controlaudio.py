...
Output: uncompressed WAV (no MP3); 12 s per stimulus.

5 control stimuli:
  - constant    (zero ramp — perceptual control)
  - increase_mild    (+0.5 oct over 12s)
  - decrease_mild    (-0.5 oct over 12s)
  - increase_strong  (+1.0 oct over 12s)
  - decrease_strong  (-1.0 oct over 12s)
"""
...
duration   = 12.0         # seconds per stimulus (matches illusion stimulus length)
