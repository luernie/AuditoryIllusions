...
#
ramps = [
    [90,  90,  8, LRA_RESONANCE_HZ, 0.1],   # Constant — control/zero ramp
    [90, 120,  8, LRA_RESONANCE_HZ, 0.1],   # Fast acceleration (up)
    [90, 110,  8, LRA_RESONANCE_HZ, 0.1],   # Mild acceleration (up)
    [90,  60,  8, LRA_RESONANCE_HZ, 0.1],   # Fast deceleration (down)
    [90,  70,  8, LRA_RESONANCE_HZ, 0.1],   # Mild deceleration (down)
]
